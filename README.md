...
[![Changelog](https://img.shields.io/badge/changelog-v0.10.1-green.svg)](https://github.com/dalance/procs/blob/master/CHANGELOG.md)
...
```
sudo rpm -i https://github.com/dalance/procs/releases/download/v0.10.1/procs-0.10.1-1.x86_64.rpm
```
