...
[![Changelog](https://img.shields.io/badge/changelog-v0.11.12-green.svg)](https://github.com/dalance/procs/blob/master/CHANGELOG.md)
...
```
sudo rpm -i https://github.com/dalance/procs/releases/download/v0.11.12/procs-0.11.12-1.x86_64.rpm
```
